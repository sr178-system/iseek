...
<div class="container">
      <p>尊敬的用户，欢迎使用i-Seek DJ产品.</p><p>本产品是提供给专业DJ,制作人作交流使用的软件，并不对行业外的人士开放.</p><p>如果不是相关行业专业人士请勿注册使用我们的产品。</p>
	<div class="page-header"></div>
	<a href="reg"><button type="button" class="btn btn-primary">知道了</button></a>
</div>
<div class="footer">
