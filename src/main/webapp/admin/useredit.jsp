...
<div class="">
<form class="form-horizontal" role="form" method="post" action="useredit?st=1&userid=${userid}">
	<div class="form-group">
		<label for="username" class="col-sm-2 control-label"><span style="color:#f00404"> * </span>登 陆 名：</label>
		<div class="col-sm-3" style="line-height:30px;">${user.loginName}</div>		
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" id="nickename" name="nickename" value="${user.nickName}">
		</div>		
	</div>	
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" id="memberExpireTimeStr" name="memberExpireTimeStr" value="<fmt:formatDate value="${user.memberExpiryDay}" type="both" pattern="yyyy-MM-dd"/>">
		</div>		
	</div>			
